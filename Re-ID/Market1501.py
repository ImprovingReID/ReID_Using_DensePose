...
class DensePose1501(Dataset):
    '''
    a wrapper of Market1501 densepose dataset
    '''
    def __init__(self, data_path, is_train = True, *args, **kwargs):
        super(DensePose1501, self).__init__(*args, **kwargs)
        self.is_train = is_train
        self.data_path = data_path
        self.imgs = os.listdir(data_path)
        self.imgs = [el for el in self.imgs if os.path.splitext(el)[1] == '.jpg']
...
if __name__ == "__main__":
    ...
    ds2 = DensePose1501('/home/bjornel/market1501/SegmentedMarket1501train/uv_maps/uv', is_train = True)
    im, _, _ = ds2[0]
    print(im.shape)
    print(im.max())
    print(im.min())
