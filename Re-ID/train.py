...
def train():
    ...
    ds = Wrapper('/mnt/analyticsvideo/DensePoseData/market1501/market1501/bounding_box_train','/mnt/analyticsvideo/DensePoseData/market1501/market1501/uv_maps_train', is_train = True)
